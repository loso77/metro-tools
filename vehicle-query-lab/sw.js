const CACHE = 'vehicle-query-lab-v0.1.4';
const APP_SHELL = ['./index.html', './manifest.json', './vehicle-lab.css', './vehicle-lab.js'];
  ...
  event.waitUntil(
    caches.keys()
      .then(keys => Promise.all(
        keys.filter(key => key.startsWith('vehicle-query-lab-') && key !== CACHE)
